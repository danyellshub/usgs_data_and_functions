...
An alternative (stronger code) could be to rename the columns in the function, and what you rename them would be an arguement.
...
join_maker <- function(df1, df2, qsite1, qsite2){
...
joined_test <- join_maker(nathrop_q, leadville_q, 'nathrop_q', 'leadville_q')
